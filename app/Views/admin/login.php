        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="index.html" class="logo logo-auth">
                                <img src="<?= base_url('/assets/img/smk.png') ?>" alt="logo" />
                            </a>
                        </div>
                    </div>
                    ...
                    <form action="<?= url_to('login') ?>" method="post">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" class="form-control form-control-xl <?php if (session('errors.password')) : ?>is-invalid<?php endif ?>" placeholder="<?= lang('Auth.password') ?>" name="password" />
                            <div class="form-control-icon">
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    <img id="banner" src="<?= base_url('/assets/img/banner.jpg') ?>">
                </div>
            </div>
        </div>
    </div>
